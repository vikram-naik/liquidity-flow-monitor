...
class EngineResult:
    ...
    def latest(self) -> dict:
        ...
        latest_dict = {
            ...
            "fas_slope": _safe(row.get("fas_slope", 0), decimals=6),
            "prt_slope": _safe(row.get("prt_slope", 0), decimals=6),
            "fas_slope_sum_5": _safe(row.get("fas_slope_sum_5", 0), decimals=6),
            "prt_slope_sum_5": _safe(row.get("prt_slope_sum_5", 0), decimals=6),
            "fas_min_10": _safe(row.get("fas_min_10", 0), decimals=4),
            "fas_max_10": _safe(row.get("fas_max_10", 0), decimals=4),
